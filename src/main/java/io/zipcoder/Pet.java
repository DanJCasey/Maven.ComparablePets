...
public class Pet implements Comparable<Pet> {
    ...
    public static Pet[] sortPetsTypeName(Pet[] petArray){
        Comparator<Pet> subclass = (o1, o2) -> {
        ...
        List<Pet> petList = new ArrayList<>(Arrays.asList(petArray));
        petList.sort(subclass);
